...
class FocalLoss(nn.Module):
    """
        Focal Loss : [1] Lin T Y ,  Goyal P ,  Girshick R , et al. Focal Loss for Dense Object Detection[J]. IEEE Transactions on Pattern Analysis & Machine Intelligence, 2017, PP(99):2999-3007. 
...
class TaylorCrossEntropyLossV1(nn.Module):
    """
        TaylorCrossEntropyLoss : [1] Banerjee K ,  Vishak P C ,  RR  Gupta, et al. Exploring Alternatives to Softmax Function[J].  2020.
        In this work, author investigate Taylor softmax, soft-margin softmax and our proposed SM-Taylor softmax as alternatives to softmax function
    """
